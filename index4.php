...
<body>
<header>
	    <img src="images/banners.jpg"	style="width:500px; height:100px;"/>
</header>
<nav>
	<div class="container">
	<ul>
			  ...
			  <form action="">
				 ...
				 <select name="">
					 ...
					 <option value="#">Châu Phú</option>
					  <option value="#">Chợ Mới</option>
					  
				 </select>
				 <select name="">
					 <option value="#">--Chọn Xã/Phường</option>
					 <option value="#">Mỹ Hòa Hưng</option>
				 </select>
...
<section class="slider-product-one">
  <div class="container">
	<div class="slider-product-one-content-one">
		<div class="slider-product-one-content-title-one">
			<h2>BÁNH MÌ SỮA</h2>
	    </div>
		  <div class="slider-product-one-content-container-one">
		      <div class="slider-product-one-content-items-one">
			<div class="slider-product-one-content-item-one">
				<img src="images/banhmibosua.jpg" alt="">
				   <div class="slider-product-one-content-item-text-one">
				   <li><img src="images/orange.png" alt=""> <p>Chào mừng 2/9</p></li>
				   <li>Bánh mì bơ sửa</li>
				   <li>Online giá rẻ</li>
				   
				   <li>15.000<sup>đ</sup></li>
		 ...
		 <div class="slider-product-one-content-item">
			<img src="images/banhmisuanhatban.jpg" alt="">
			   <div class="slider-product-one-content-item-text">
			   <li><img src="images/orange.png" alt=""> <p>Chào mừng 2/9</p></li>
			   <li>Bánh mì sữa Nhật Bản</li>
			   <li>Online giá rẻ</li>
			   
			   <li>20.000<sup>đ</sup></li>
	 ...
	 <div class="slider-product-one-content-item">
				<img src="images/banhmisuadua.jpg" alt="">
				   <div class="slider-product-one-content-item-text">
				    <li><img src="images/orange.png" alt=""> <p>Chào mừng 2/9</p></li>
				   <li>Bánh mì sữa bắp</li>
				   <li>Online giá rẻ</li>
		 ...
		 <div class="slider-product-one-content-item">
				<img src="images/banhmisuachua.jpg" alt="">
				   <div class="slider-product-one-content-item-text">
				    <li><img src="images/orange.png" alt=""> <p>Chào mừng 2/9</p></li>
				   <li>Bánh mì sữa chua</li>
				   <li>Online giá rẻ</li>
		 ...
		 <div class="slider-product-one-content-item">
				<img src="images/banhminhankem.jpg" alt="">
				   <div class="slider-product-one-content-item-text">
				    <li><img src="images/orange.png" alt=""> <p>Chào mừng 2/9</p></li>
				   <li>Bánh mì nhân Kem</li>
				   <li>Online giá rẻ</li>
			  ...
			  <div class="slider-product-one-content-items-one">
					<div class="slider-product-one-content-item">
						<img src="images/banhmichamsua.jpg" alt="">
						   <div class="slider-product-one-content-item-text">
						    <li><img src="images/orange.png" alt=""> <p>Chào mừng 2/9</p></li>
						   <li>Bánh mì chấp sữa</li>
						   <li>Online giá rẻ</li>
						   
						   <li>7.599.000<sup>đ</sup></li>
				 ...
				 <div class="slider-product-one-content-item">
					<img src="images/banhmibosuamem.jpg" alt="">
					   <div class="slider-product-one-content-item-text">
					    <li><img src="images/orange.png" alt=""> <p>Chào mừng 2/9</p></li>
					   <li>Bánh mì bơ sữa mềm</li>
					   <li>Online giá rẻ</li>
			 ...
			 <div class="slider-product-one-content-item">
						<img src="images/banhmingotnhansuadua.jpg" alt="">
						   <div class="slider-product-one-content-item-text">
						    <li><img src="images/orange.png" alt=""> <p>Chào mừng 2/9</p></li>
						   <li>Bánh mì ngọt nhân sữa dừa</li>
						   <li>Online giá rẻ</li>
				 ...
				 <div class="slider-product-one-content-item">
						<img src="images/banhmisuadua.jpg" alt="">
						   <div class="slider-product-one-content-item-text">
						    <li><img src="images/orange.png" alt=""> <p>Chào mừng 2/9</p></li>
						   <li>Bánh mì sữa dừa</li>
						   <li>Online giá rẻ</li>
						   
						   <li>10.000<sup>đ</sup></li>
				 ...
				 <div class="slider-product-one-content-item">
						<img src="images/banhmiduathainguyen.jpg" alt="">
						   <div class="slider-product-one-content-item-text">
						    <li><img src="images/orange.png" alt=""> <p>Chào mừng 2/9</p></li>
						   <li>bánh mì dừa Thái Nguyên</li>
						   <li>Online giá rẻ</li>
						   
						   <li>30.000<sup>đ</sup></li>
