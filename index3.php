...
<section class="slider-product-one">
  <div class="container">
	<div class="slider-product-one-content-one">
		<div class="slider-product-one-content-title-one">
		  ...
		  <div class="slider-product-one-content-container-one">
			...
			<div class="slider-product-one-content-item-one">
				<img src="images/banhmidatbiet.jpg" alt="">
				   <div class="slider-product-one-content-item-text-one">
				   <li><img src="images/cam.png" alt=""> <p>Chào mừng 2/9</p></li>
		 ...
		 <div class="slider-product-one-content-item">
			<img src="images/banhmithitga.jpg" alt="">
			   <div class="slider-product-one-content-item-text">
			     <li><img src="images/cam.png" alt=""> <p>Chào mừng 2/9</p>
			   <li>Bành mì thịt gà</li>
			   <li>Online giá rẻ</li>
			   
			   <li>35.000<sup>đ</sup></li>
	 ...
	 <div class="slider-product-one-content-item">
				<img src="images/banhmitrungthitheo.jpg" alt="">
				   <div class="slider-product-one-content-item-text">
				    <li><img src="images/cam.png" alt=""> <p>Chào mừng 2/9</p>
				   <li>Bánh mì trứng thịt heo</li>
				   <li>Online giá rẻ</li>
		 ...
		 <div class="slider-product-one-content-item">
				<img src="images/banhmithitheotrang.jpg" alt="">
				   <div class="slider-product-one-content-item-text">
				     <li><img src="images/cam.png" alt=""> <p>Chào mừng 2/9</p>
				   <li>Bánh mì thịt heo trắng</li>
				   <li>Online giá rẻ</li>
		 ...
		 <div class="slider-product-one-content-item">
				<img src="images/banhmithitheodo.jpg" alt="">
				   <div class="slider-product-one-content-item-text">
				     <li><img src="images/cam.png" alt=""> <p>Chào mừng 2/9</p>
				   <li>Bánh mì thịt heo đỏ</li>
				   <li>Online giá rẻ</li>
			  ...
			  <div class="slider-product-one-content-items-one">
					<div class="slider-product-one-content-item">
						<img src="images/banhmipatee.jpeg" alt="">
						   <div class="slider-product-one-content-item-text">
						    <li><img src="images/cam.png" alt=""> <p>Chào mừng 2/9</p>
						   <li>Bánh mì patee đặt biệt</li>
						   <li>Online giá rẻ</li>
				 ...
				 <div class="slider-product-one-content-item">
					<img src="images/faifobanhmi.png" alt="">
					   <div class="slider-product-one-content-item-text">
					    <li><img src="images/cam.png" alt=""> <p>Chào mừng 2/9</p>
					   <li>faifo Bánh Mì</li>
					   <li>Online giá rẻ</li>
			 ...
			 <div class="slider-product-one-content-item">
				 ...
				 <div class="slider-product-one-content-item">
						<img src="images/banhmitamgiacto.jpg" alt="">
						   <div class="slider-product-one-content-item-text">
						     <li><img src="images/cam.png" alt=""> <p>Chào mừng 2/9</p>
						   <li>Bánh mì tam giác to</li>
						   <li>Online giá rẻ</li>
				 ...
				 <div class="slider-product-one-content-item">
						<img src="images/banhmithitkhiadatbiet.jpg" alt="">
						   <div class="slider-product-one-content-item-text">
						     <li><img src="images/cam.png" alt=""> <p>Chào mừng 2/9</p>
						   <li>Bánh mì khịt khịa đặt biệt</li>
						   <li>Online giá rẻ</li>
