...
<form action="index.php?do=doimatkhau_xuly" method="post">
	<table class="Form">
		<input type="hidden" value="<?php echo $_SESSION['MaND']; ?>" name="MaNguoiDung" /><!--lay duoc trang thai dang nhap nguoi dung hien tai-->
		<tr>
			<td>Mật khẩu cũ:</td>
	...
	<input type="submit" value="Cập nhật mật khẩu" name="doimatkhau"/>
</form>