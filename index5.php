  ...
  <div class="container">
	<div class="slider-product-one-content-one">
		<div class="slider-product-one-content-title-one">
		  ...
		  <div class="slider-product-one-content-container-one">
			...
			<div class="slider-product-one-content-item-one">
				<img src="images/sandwichkepthit.jpg" alt="">
				   <div class="slider-product-one-content-item-text-one">
				   <li><img src="images/icon1.png" alt=""> <p>Chào mừng 2/9</p></li>
				   <li>Sandwich Salach</li>
				   <li>Online giá rẻ</li>
		 ...
		 <div class="slider-product-one-content-item">
			<img src="images/sandwichkeptrung.jpg" alt="">
			   <div class="slider-product-one-content-item-text">
			   <li><img src="images/icon1.png" alt=""> <p>Chào mừng 2/9</p></li>
			   <li>Sandwich kẹp trứng</li>
			   <li>Online giá rẻ</li>
	 ...
	 <div class="slider-product-one-content-item">
		 ...
		 <div class="slider-product-one-content-item">
				<img src="images/sandwichkepchatom.jpg" alt="">
				   <div class="slider-product-one-content-item-text">
				   <li><img src="images/icon1.png" alt=""> <p>Chào mừng 2/9</p></li>
				   <li>Sandwich kẹp chả tôm</li>
				   <li>Online giá rẻ</li>
				  
				   <li>18.599.000<sup>đ</sup></li>
		 ...
		 <div class="slider-product-one-content-item">
				<img src="images/sandwichbo.jpg" alt="">
				   <div class="slider-product-one-content-item-text">
				   <li><img src="images/icon1.png" alt=""> <p>Chào mừng 2/9</p></li>
				   <li>Sandwich Bơ</li>
				   <li>Online giá rẻ</li>
			 ...
			 <div class="slider-product-one-content-item">
						<img src="images/sandwichhaisan.jpg" alt="">
						   <div class="slider-product-one-content-item-text">
						   <li><img src="images/icon1.png" alt=""> <p>Chào mừng 2/9</p></li>
						   <li>Sandwich trứng</li>
						   <li>Online giá rẻ</li>
				 ...
				 <div class="slider-product-one-content-item">
						<img src="images/sandwichheo.jpg" alt="">
						   <div class="slider-product-one-content-item-text">
						   <li><img src="images/icon1.png" alt=""> <p>Chào mừng 2/9</p></li>
						   <li>Sandwich heo</li>
						   <li>Online giá rẻ</li>
